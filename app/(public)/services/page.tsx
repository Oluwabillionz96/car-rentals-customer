      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-black text-text-100 mb-6 tracking-tight">
            Premium <span className="text-primary">Transportation</span>{" "}
            Solutions
          </h1>
          <p className=" md:text-lg text-text-200 max-w-2xl mx-auto mb-10">
            From luxury wedding convoys to seamless airport transfers, we
            provide professional chauffeur services tailored to your specific
            needs.
          </p>
      ...
      <section className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {services.map((service) => {
            return (
              <ServiceCard key={service.id} service={service} isPage={true} />
            );
          })}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-text-200 max-w-xl mx-auto">
              We go beyond just car rentals. We provide an experience built on
              reliability, comfort, and professional service.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto bg-primary rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-lg mb-10 max-w-xl mx-auto">
              Join thousands of satisfied clients who trust us for their luxury
