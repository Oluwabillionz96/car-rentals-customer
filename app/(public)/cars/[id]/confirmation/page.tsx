...
import { getCar, Car } from "@/constants/cars";
import {
  CheckCircle2,
  Download,
  Calendar,
    ...
    <div className="hidden md:block">
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-4 flex flex-col gap-6">
          <BookingIDCard id="SCR-2024-00142" />
          <CustomerDetailsCard
            name={userName}
            email={userEmail}
            phone={userPhone}
      ...
      <div className="flex justify-between items-start mb-5">
        <div>
          ...
          <div className="flex items-center gap-2">
            <p className="text-[#3b82f6] font-bold text-sm">SCR-2024-00142</p>
            <CopyButton text="SCR-2024-00142" />
          </div>
        </div>
...
function BookingIDCard({ id }: { id: string }) {
  return (
...
function SupportTooltip({ mobile }: { mobile?: boolean }) {
  return (
    <div
