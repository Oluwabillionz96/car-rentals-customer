...
export const MOCK_CARS: Car[] = [
  {
    ...
    description: "Experience luxury and reliability with the 2023 Toyota Camry. Perfectly suited for executive travel or family trips, this sedan offers a smooth ride, advanced safety features, and exceptional fuel efficiency.",
    gallery: [
    ...
    features: ["Bluetooth Audio", "Rear Camera", "AC Front & Rear", "USB Charging", "Dual-zone Climate", "Cruise Control"],
    location: {
  ...
  },
  {
    ...
    description: "The G-Class is an icon of off-road capability and luxury. With its distinctive design and unparalleled performance, it's the ultimate statement of style and power for any journey.",
    gallery: [
    ...
    features: ["Premium Sound", "All-Wheel Drive", "Panoramic Sunroof", "Lane Keep Assist", "Heated Seats", "360 Camera"],
    location: {
  ...
  },
  {
    ...
    description: "Dynamic and sophisticated, the Range Rover Sport combines luxury with legendary off-road capability. It delivers an assertive drive with refined power for those who demand more.",
    gallery: [
    ...
    features: ["Adaptive Dynamics", "Matrix LED", "Meridian Sound", "Touch Pro Duo", "Interactive Driver Display", "Terrain Response"],
    location: {
  ...
  },
  {
    ...
    description: "The King of all Roads. The Land Cruiser provides exceptional durability and reliability without compromising on comfort. Its spacious 7-seat interior is perfect for large families or groups.",
    gallery: [
    ...
    features: ["Diff Lock", "Crawl Control", "4-Zone Climate", "Rear Seat Entertainment", "Ventilated Seats", "Cool Box"],
    location: {
      office: "Ikeja Office",
  ...
  },
  {
    ...
    description: "The Lexus ES 350 is the epitome of quiet luxury. Exceptionally comfortable and impeccably crafted, it provides a serene driving experience like no other.",
    gallery: [
      "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=2070&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1616422285623-13ff0167c95c?q=80&w=2070&auto=format&fit=crop"
    ],
    features: ["Mark Levinson Audio", "Quiet Cabin", "Smart Access", "Apple CarPlay", "Android Auto", "Lexus Safety System"],
    location: {
      office: "Victoria Island Office",
      address: "12 Adeola Hopewell St, Lagos"
    }
  },
  {
    ...
    price: 30000,
    image: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=2070&auto=format&fit=crop",
    description: "The Honda Accord is the gold standard for executive transport. Reliable, spacious, and equipped with modern technology, it's perfect for both work and play.",
    gallery: [
      "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=2070&auto=format&fit=crop"
    ],
    features: ["Honda Sensing", "Wireless Charging", "Sunroof", "Heated Seats", "Blind Spot Info", "Remote Start"],
    location: {
      office: "Victoria Island Office",
      address: "12 Adeola Hopewell St, Lagos"
    }
