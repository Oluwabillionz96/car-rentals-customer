          ...
          {step === 1 ? (
            ...
            >
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                      <div className="flex-1 w-full h-16 flex items-center justify-between px-6 rounded-2xl border-2 border-slate-100 bg-slate-50/30">
                        <button
                          ...
                          className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-text-100 hover:bg-primary hover:text-white hover:border-primary transition-all shadow-sm active:scale-95"
                        >
                          <Minus size={20} />
                        </button>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full min-h-[100px] p-4 rounded-2xl border border-border-100 outline-none focus:border-primary transition-colors text-text-100 placeholder:text-text-400"
              ...
              <div className="pt-6 flex gap-4">
                ...
                <Button type="submit" form="booking-form" className="flex-2">
                  Confirm Booking
                </Button>
              </div>
            </motion.div>
