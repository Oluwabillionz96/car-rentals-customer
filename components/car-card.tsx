    ...
    <div className="w-full cursor-pointer max-w-[400px] bg-white border border-[#F1F5F9] rounded-lg md:rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group flex flex-col h-full">
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="hidden md:block">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-[#94A3B8] text-xs font-bold uppercase tracking-widest mb-1">
                Per Day
              </span>
        ...
        <div className="md:hidden mt-auto">
          <button className="w-full border-2 border-[#E2E8F0] py-3 rounded-lg font-bold text-text-100 active:scale-[0.98] transition-all hover:bg-slate-50 text-sm">
            Book Now
          </button>
        </div>
      </div>
